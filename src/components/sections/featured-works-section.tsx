...
import type { FeaturedWork } from "@/lib/site-data";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1480px]">
        ...
        <StoryStagger className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {featuredWorks.map((work) => (
            <StoryItem key={work.title}>
              <a
        ...
        <StoryReveal className="mt-12 flex justify-center">
          <Button
            asChild
